...
class SpaceH130 extends StatelessWidget {
  const SpaceH130({super.key});

  @override
  Widget build(BuildContext context) {
    return SizedBox(height: 130.0);
  }
}
